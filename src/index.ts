...
import { validateApiKey } from "./services/vastai.js";
...
async function runStdio(): Promise<void> {
  console.error("vastai-blade-mcp: starting in stdio mode...");
...
async function runHttp(): Promise<void> {
  ...
  console.error(`vastai-blade-mcp: starting in HTTP mode on port ${port}...`);
  ...
  // Health check
  app.get("/health", (c) => c.json({ status: "ok", server: "vastai-blade-mcp" }));
